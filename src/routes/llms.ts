...
llms.get('/', (c) =>
  c.text(
    [
      ...
      "window.yt('Signup')",
      '',
      'Events are counted by name, with no cookies and no custom properties. Read them back with the by=event breakdown on the stats endpoint.',
      '',
      '## REST API',
      '',
      ...
      '- by. A breakdown dimension, or a comma list of them. One or more of page, referrer, country, browser, device, event.',
      '',
      '### Response shape',
      '',
