...
llms.get('/', (c) =>
  c.text(
    [
      ...
      "window.yt('Signup')",
      '',
      'Pass an optional second argument to attach custom properties. Values may be strings, numbers or booleans.',
      '',
      "window.yt('Signup', { plan: 'pro', referral: 'newsletter' })",
      '',
      'Read events back with the by=event breakdown on the stats endpoint, counted by name. Break one property down by value with by=prop:KEY, for example by=prop:plan.',
      '',
      '## REST API',
      '',
      ...
      '- by. A breakdown dimension, or a comma list of them. One or more of page, referrer, country, browser, device, event, or prop:KEY to break custom events down by a custom property value.',
      '',
      '### Response shape',
      '',
