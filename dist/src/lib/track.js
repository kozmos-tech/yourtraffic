...
export async function visitorHash(projectId, ip, ua) {
...
export function referrerHost(referrer, self) {
    if (!referrer)
        return null;
    try {
        ...
        : /Android/.test(s) ? 'Android'
            : /(iPhone|iPad|iPod)/.test(s) ? 'iOS'
                : /Mac OS X/.test(s) ? 'macOS'
                    : /Linux/.test(s) ? 'Linux'
                        : 'Other';
    const device = /Mobile|iPhone|iPod|Android.*Mobile/.test(s) ? 'mobile'
